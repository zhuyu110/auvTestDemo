...
public class Ch34xSerialDriver implements com.hoho.android.usbserial.driver.UsbSerialDriver {

	private static final String TAG = Ch34xSerialDriver.class.getSimpleName();

	private final UsbDevice mDevice;
	private final com.hoho.android.usbserial.driver.UsbSerialPort mPort;
	...
	public static Map<Integer, int[]> getSupportedDevices() {
		...
		supportedDevices.put(com.hoho.android.usbserial.driver.UsbId.VENDOR_QINHENG, new int[]{
				com.hoho.android.usbserial.driver.UsbId.QINHENG_CH340,
