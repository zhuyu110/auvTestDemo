...
import com.auv.sienlockdemo.BuildConfig;
...
public class ProlificSerialDriver implements com.hoho.android.usbserial.driver.UsbSerialDriver {
    ...
    public static Map<Integer, int[]> getSupportedDevices() {
        ...
        supportedDevices.put(com.hoho.android.usbserial.driver.UsbId.VENDOR_PROLIFIC,
